...
public class RoundedImg extends ImageView {
    ...
    public RoundedImg(Context context) {
        super(context);
    }

    public RoundedImg(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public RoundedImg(Context context, AttributeSet attrs, int defStyle) {
        ...
        mCornerRadius = a.getDimensionPixelSize(R.styleable.RoundedImageView_round_corner_radius, -1);
        ...
        mRoundBackground = a.getBoolean(R.styleable.RoundedImageView_round_round_background, false);
        mOval = a.getBoolean(R.styleable.RoundedImageView_round_is_oval, false);
